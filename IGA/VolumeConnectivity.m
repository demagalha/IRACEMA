function [global_basis_index, element_local_mapping]  = VolumeConnectivity(GeometryObj);
...
for e=1:ELEMENTS
    ...
    element_basis = sub2ind(array_size,element_spans(:,1),element_spans(:,2),element_spans(:,3));
